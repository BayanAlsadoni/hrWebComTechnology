          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                CustomeTextFieldWidget('التسمية القديمة',
                    enable: false,
                    txtController:
                        TextEditingController(text: 'my department')),
                CustomeTextFieldWidget('التسمية الجديدة',
                    enable: false,
                    txtController:
                ...
                CustomeTextFieldWidget(
                  'تاريخ الترقية',
                  enable: false,
                  txtController: TextEditingController(text: 'this bla bla'),
                ),
